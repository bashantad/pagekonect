...
states = State.create({:state => "Victoria", :country => "Australia"})
states = State.create({:state => "Western Australia", :country => "Australia"})
states = State.create({:state => "South Australia", :country => "Australia"})
states = State.create({:state => "Victoria", :country => "Australia"})
states = State.create({:state => "New South Wales", :country => "Australia"})
states = State.create({:state => "Queensland", :country => "Australia"})
states = State.create({:state => "Tasmania", :country => "Australia"})